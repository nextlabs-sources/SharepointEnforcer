...
my	$PCJDK7Dir = "$mainexternalDir/j2sdk/UnlimitedJCEPolicyJDK7";
...
my	$installDir = "$buildRootDir/install/spe2013";
...
my	$srcBinSP2013CsDir = "$buildRootDir/bin/release_dotnet/SP2013release";
...
my	@binSP2013CsFileList = (
		...
		["QueryCloudAZSDK.dll",		$versionStr]
#,
...
InstallHelper::copyListVersionRequired($srcBinSP2013CsDir, $destBinCsDir, \@binSP2013CsFileList);
...
InstallHelper::copyVersionRequired("$externalDir/microsoft/sharepoint/sp2013/DocumentFormat.OpenXml.dll","$destBinCsDir/DocumentFormat.OpenXml.dll","2.5.5631.0");
#
...
my  $srcRMSJarZipDir = "S:/build/release_artifacts/RightsManagementJavaSDK/1.0.7.0/4/RMSDK-1.0.7.0-4-201702130101-build.zip";
my	$destRMSJarZipDir = "$buildRootDir/RMSjars/";
my	$destRMSJarDir = "$assemblyDir/RMSjars";
my	$destSecurityJarDir = "$assemblyDir/SecurityJars";

my	$srcResDir = "$installDir/resource";
my	$srcSpeDir = "$buildRootDir/prod";
my	$srcSpeConfigDir = "$buildRootDir/configuration";
my	$srcSpeConfigSp2013Dir = "$srcSpeConfigDir/sp2013";
my	$destResDir = "$assemblyDir/resource";
my	$destConfigDir = "$assemblyDir/configuration";
my	$destConfigSp2013Dir = "$assemblyDir/configuration/sp2013";

#RMS jars
rmtree([ "$destRMSJarZipDir" ]);
if(system("unzip $srcRMSJarZipDir -d $destRMSJarZipDir"))
{
	print "unzip RMSDK-1.0.7.0-4-201702130101.zip failed.\n";
}

InstallHelper::copyRequired("$destRMSJarZipDir/RMJavaSdk.jar",				"$destRMSJarDir/RMJavaSdk.jar");
InstallHelper::copyRequired("$destRMSJarZipDir/slf4j-api-1.7.13.jar",				"$destRMSJarDir/slf4j-api-1.7.13.jar");
InstallHelper::copyRequired("$destRMSJarZipDir/RMJavaSdk_xmlbeans.jar",				"$destRMSJarDir/RMJavaSdk_xmlbeans.jar");
InstallHelper::copyRequired("$destRMSJarZipDir/KeyManagementService.jar",				"$destRMSJarDir/KeyManagementService.jar");

# PC Security jars.
InstallHelper::copyRequired("$PCJDK7Dir/local_policy.jar",				"$destSecurityJarDir/local_policy.jar");
InstallHelper::copyRequired("$PCJDK7Dir/US_export_policy.jar",				"$destSecurityJarDir/US_export_policy.jar");

# Common
InstallHelper::copyRequired("$srcResDir/README.txt",									"$destResDir/README.txt");
InstallHelper::copyRequired("$srcBinSP2013CsDir/NextLabs.Entitlement.wsp",				"$destBinCsDir/NextLabs.Entitlement.wsp");
...
InstallHelper::copyRequired("$srcSpeConfigDir/sp2013/InstallBasicFeatureFor2013Mixed.ps1",		"$destBinCsDir/InstallBasicFeatureFor2013Mixed.ps1");
InstallHelper::copyRequired("$srcSpeConfigDir/sp2013/InstallEventReceiverFeatureFor2013Mixed.ps1",		"$destBinCsDir/InstallEventReceiverFeatureFor2013Mixed.ps1");
InstallHelper::copyRequired("$srcSpeConfigDir/sp2013/UninstallBasicFeatureFor2013Mixed.ps1",		"$destBinCsDir/UninstallBasicFeatureFor2013Mixed.ps1");
InstallHelper::copyRequired("$srcSpeConfigDir/sp2013/UninstallEventReceiverFeatureFor2013Mixed.ps1",		"$destBinCsDir/UninstallEventReceiverFeatureFor2013Mixed.ps1");
...
InstallHelper::copyRequired("$srcSpeConfigDir/XHeaderConfig.xml",				"$destConfigDir/XHeaderConfig.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/PreAuthPluginConfig.ini",				"$destConfigDir/PreAuthPluginConfig.ini");
InstallHelper::copyRequired("$srcSpeConfigDir/PluginFrame.ini",				"$destConfigDir/PluginFrame.ini");
...
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs-RightsProtect32.png",				"$destConfigDir/NextLabs-RightsProtect32.png");
InstallHelper::copyRequired("$srcSpeConfigDir/rmskmc-keystore.jks",				"$destConfigDir/rmskmc-keystore.jks");
InstallHelper::copyRequired("$srcSpeConfigDir/rmskmc-truststore.jks",				"$destConfigDir/rmskmc-truststore.jks");
InstallHelper::copyRequired("$srcSpeConfigDir/KeyManagementService.properties",				"$destConfigDir/KeyManagementService.properties");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs-SecureViewer32.png",				"$destConfigDir/NextLabs-SecureViewer32.png");
...
InstallHelper::copyRequired("$srcSpeConfigDir/FeatureManager/Active.gif",				"$destConfigDir/FeatureManager/Active.gif");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.Basic/Feature.xml",				"$destConfigDir/NextLabs.Entitlement.Basic/Feature.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.Basic/BasicElements/Elements.xml",				"$destConfigDir/NextLabs.Entitlement.Basic/BasicElements/Elements.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.Basic/BasicElements/spesitemenus.xml",				"$destConfigDir/NextLabs.Entitlement.Basic/BasicElements/spesitemenus.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.EventReceiver/Feature.xml",				"$destConfigDir/NextLabs.Entitlement.EventReceiver/Feature.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.EventReceiver/EventReceiverElements/itemElements.xml",				"$destConfigDir/NextLabs.Entitlement.EventReceiver/EventReceiverElements/itemElements.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.EventReceiver/EventReceiverElements/listElements.xml",				"$destConfigDir/NextLabs.Entitlement.EventReceiver/EventReceiverElements/listElements.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/NextLabs.Entitlement.EventReceiver/EventReceiverElements/menus.xml",				"$destConfigDir/NextLabs.Entitlement.EventReceiver/EventReceiverElements/menus.xml");
InstallHelper::copyRequired("$srcSpeConfigDir/RightMangerSDK.config",				"$destConfigDir/RightMangerSDK.config");

if (system("cp -fR \"$srcSpeConfigSp2013Dir\" \"$destConfigSp2013Dir\""))
{
	die "### ERROR: Failed to copy configuration files from $srcSpeConfigSp2013Dir to $destConfigSp2013Dir.\n";
}
...
InstallHelper::copyRequired("$srcSpeConfigSp2013Dir/built-in components for PLE(2013).xml",		"$package64Dir/PLE.xml");
