...
my	$installDir = "$buildRootDir/install/spe2019";
...
my	$srcBinSP2019CsDir = "$buildRootDir/bin/release_dotnet/SP2019release";
...
InstallHelper::copyListVersionRequired($srcBinSP2019CsDir, $destBinCsDir, \@binSP2019CsFileList);
...
InstallHelper::copyVersionRequired("$externalDir/microsoft/sharepoint/sp2019/DocumentFormat.OpenXml.dll","$destBinCsDir/DocumentFormat.OpenXml.dll","2.5.5631.0");
#
...
my	$srcSpeConfigSp2019Dir = "$srcSpeConfigDir/sp2019";
my	$destResDir = "$assemblyDir/resource";
my	$destConfigDir = "$assemblyDir/configuration";
my	$destConfigSp2019Dir = "$assemblyDir/configuration/sp2019";

# Common
InstallHelper::copyRequired("$srcResDir/README.txt",									"$destResDir/README.txt");
InstallHelper::copyRequired("$srcBinSP2019CsDir/NextLabs.Entitlement.wsp",				"$destBinCsDir/NextLabs.Entitlement.wsp");
...
InstallHelper::copyRequired("$srcSpeConfigDir/sp2019/InstallBasicFeatureFor2019Mixed.ps1",		"$destBinCsDir/InstallBasicFeatureFor2019Mixed.ps1");
InstallHelper::copyRequired("$srcSpeConfigDir/sp2019/InstallEventReceiverFeatureFor2019Mixed.ps1",		"$destBinCsDir/InstallEventReceiverFeatureFor2019Mixed.ps1");
InstallHelper::copyRequired("$srcSpeConfigDir/sp2019/UninstallBasicFeatureFor2019Mixed.ps1",		"$destBinCsDir/UninstallBasicFeatureFor2019Mixed.ps1");
InstallHelper::copyRequired("$srcSpeConfigDir/sp2019/UninstallEventReceiverFeatureFor2019Mixed.ps1",		"$destBinCsDir/UninstallEventReceiverFeatureFor2019Mixed.ps1");
...
if (system("cp -fR \"$srcSpeConfigSp2019Dir\" \"$destConfigSp2019Dir\""))
{
	die "### ERROR: Failed to copy configuration files from $srcSpeConfigSp2019Dir to $destConfigSp2019Dir.\n";
}
...
# 64-bit
InstallHelper::copyRequired("$srcSpeConfigSp2019Dir/built-in components for PLE(2019).xml",		"$package64Dir/PLE.xml");
