 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_GetKey(CEHandle handle, CEString keyRingName, CEKeyID id, CEKey *key, CEint32 processID, CEint32 timeout);
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_CreateKeyRing(CEHandle handle, CEString keyRingName, CEint32 processID, CEint32 timeout);
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_SetKey(CEHandle handle, CEString keyRingName, CEKey key, CEint32 processID, CEint32 timeout);
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_GenerateKey(CEHandle handle, CEString keyRingName, CEint32 keyLen, CEKeyID *keyID, CEint32 processID, CEint32 timeout);
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_DeleteKey(CEHandle handle, CEString keyRingName, CEKeyID id, CEint32 processID, CEint32 timeout); 
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_DeleteKeyRing(CEHandle handle, CEString keyRingName, CEint32 processID, CEint32 timeout);
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_ListKeyRings(CEHandle handle, CEKeyRing *keyRings, CEint32 *size, CEint32 processID, CEint32 timeout);
 ...
 */
KEYMANAGEMENTEXPORT
CEResult_t CEKey_ListKeys(CEHandle handle, CEKeyRing *keyRing, CEint32 processID, CEint32 timeout);
