...
<asp:Content ID="Content6" ContentPlaceHolderID="PlaceHolderMain" runat="server">
  ...
  <br /><br />
  <font color="red">
    <asp:Label ID="lblInfo" runat="server" Text="&nbsp;&nbsp;Clearing the Content Analysis log will clear log information for all document libraries and lists within the site collection." />
  </font>
  <hr />
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server">
  ...
  <SharePoint:EncodedLiteral runat="server" Text="Content Analysis Log Viewer" EncodeMethod="HtmlEncode" />
</asp:Content>
