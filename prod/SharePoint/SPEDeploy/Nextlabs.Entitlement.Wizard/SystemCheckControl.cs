  ...
  public partial class SystemCheckControl : InstallerControl
  {
    ...
    private bool ExecuteCheck(int index)
    {
      ...
      try
      {
        ...
        {
          imageLabel.Image = global::Nextlabs.Entitlement.Wizard.Properties.Resources.CheckOk;
          textLabel.Text = check.OkText;
        } else if (result == SystemCheckResult.Error)
        {
          errors++;
          imageLabel.Image = global::Nextlabs.Entitlement.Wizard.Properties.Resources.CheckFail;
        ...
        {
          nextImageLabel.Image = global::Nextlabs.Entitlement.Wizard.Properties.Resources.CheckPlay;
        }
    ...
    private void AddCheck(SystemCheck check)
    {
      ...
      imageLabel.Image = global::Nextlabs.Entitlement.Wizard.Properties.Resources.CheckWait;
    ...
    private void ConfigureControls()
    {
      ...
      else
      {
        ...
        else
        {
          ...
          //We only need to support remove and upgradde scenario
          Form.ContentControls.Add(Program.CreateUpgradeControl());
        }
      }
    }
    ...
    private void AddInstallControls()
    {
      ...
      {
         //Donot need EULA now, move this to Installer 
...
#elif SP2010
      const string REGSP = @"SOFTWARE\Microsoft\Shared Tools\Web Server Extensions\14.0";
#else
...
#elif SP2010
      const string REGMOSS = @"SOFTWARE\Microsoft\Office Server\14.0";
#else
