...
namespace NextLabs.Deployment.Features.NextLabs.Entitlement.Administration
{
    ...
    [Guid("290158c9-5103-4abb-8f56-8baaf5b53921")]
    public class NextLabsEntitlementEventReceiver : SPFeatureReceiver
    {
        //in version9.0, we do not need modify central admin web.config here, instead we use SPEdeploy.ps1 to modify web.config because of BUG 68150
#if SPEVersion9
