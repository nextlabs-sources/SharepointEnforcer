...
using Progress = NextLabs.Diagnostic.Progress;
...
namespace NextLabs.Solution.Features.NextLabsEntitlementBasic
{
    ...
    [Guid("26032287-3327-453e-bf4c-877e578136d3")]
    public class NextlabsEntitlementBasicEventReceiver : SPFeatureReceiver
    {
        ...
        private int EnableSP2010JobUpdate()
        {
            ...
            {
                NLLogger.OutputLog(LogLevel.Error, "Exception during EnableSP2010JobUpdate:", null, e);
                return 6;
            }
            return 0;
        }
        ...
        private int DisableSP2010JobUpdate()
        {
            ...
            {
                NLLogger.OutputLog(LogLevel.Debug, "Exception during DisableSP2010JobUpdate:", null, e);
                return 7;
            }
            return 0;
        }
...
#warning Below line Need Delete
        ...
        public override void FeatureUninstalling(SPFeatureReceiverProperties properties)
        {
            ...
            {
                NLLogger.OutputLog(LogLevel.Error, "Exception during FeatureUninstalling GetSPEIntalledPath:", null, ee);
            }
            ...
            foreach (object key in keyArray)
            {
                ...
                if (name.Contains("Nextlabs"))
                {
                    ...
                    {
                        NLLogger.OutputLog(LogLevel.Error, "Exception during FeatureUninstalling:", null, ee);
                    }
                }
            }
            farm.Update();
